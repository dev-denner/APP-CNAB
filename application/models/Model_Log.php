  ...
  public function get($ID) {
    $query = $this->db->query('
       SELECT LO.' . self::ID . ', TO_CHAR(LO.' . self::DATA . ', \'DD/MM/YYYY HH24:MI:SS\') DATA, LO.' . self::XLS . ', 
              ...
              EM.' . Model_Empresa::NOME . ' EMPRESA, FI.' . Model_Filial::NOME . ' FILIAL, BA.' . Model_Banco::NOME . ' BANCO, 
              OP.' . Model_Tipo_Operacao::NOME . ' OPERACAO, TO_CHAR(PR.' . Model_Processo::DATAPAG . ', \'DD/MM/YYYY\') DATAPAG,
              PR.' . Model_Processo::VALOR . ' VALOR, BA.' . Model_Banco::ID . ' NUMBANCO, 
       ...
       INNER JOIN ' . Model_Filial::TABELA . ' FI ON FI.' . Model_Filial::ID . ' = PR.' . Model_Processo::FILIAL . '
