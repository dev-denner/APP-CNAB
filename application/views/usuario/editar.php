  ...
  <form class="form-horizontal" role="form" method="post" action="<?php echo base_url('usuario/atualizar'); ?>">
    ...
    <fieldset class="col-sm-6 center col-lg-offset-3">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <input type="password" class="form-control" id="senha_usu" name="<?php echo model_usuario::SENHA; ?>" placeholder="Senha para a entrada no sistema" value="<?php echo $usuario[model_usuario::SENHA]; ?>" />
        </div>
      </div>
      <div class="form-group">
        <label for="senha_usu" class="col-sm-3 control-label">Confirmação da Senha</label>
        <div class="col-sm-9">
          <input type="password" class="form-control" id="confirm_senha" name="confirm_senha" placeholder="Confirme sua senha" value="<?php echo $usuario[model_usuario::SENHA]; ?>" />
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <select class="form-control" id="acesso" name="<?php echo model_usuario::ACESSO; ?>" required >
            ...
            <option value="1" <?php echo $usuario[model_usuario::ACESSO] == 1 ? 'selected': ''; ?>>Usuario</option>
